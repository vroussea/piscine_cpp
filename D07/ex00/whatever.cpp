...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/18 15:48:09 by vroussea          #+#    #+#             */
/*   Updated: 2018/01/18 15:48:09 by vroussea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     main(void) {
    ...
    std::cout << "max between " << s1 << " and " << s2 << " : " << ::max(s1, s2) << std::endl;
    std::cout << "max between " << s1 << " and " << s1 << " : " << ::max(s1, s1) << std::endl;
    std::cout << "min between " << s1 << " and " << s2 << " : " << ::min(s1, s2) << std::endl;
    std::cout << "min between " << s1 << " and " << s1 << " : " << ::min(s1, s1) << std::endl;
